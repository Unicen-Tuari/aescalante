    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          ...
          <button type="button" class="btn btn-success">Compartir a Home</button>        </div>
      </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <?php
              ...
              ?>
              <td>
              <p><?php echo $player['nombre'] ?> </p>
              </td>
              <td>
               <p><?php echo $player['apellido'] ?></p>
              </td>
              <td>
              <p><?php echo $player['posicion'] ?> </p>
              </td>
              <td>
              <p><?php echo $player['apodo'] ?> </p>
              ...
              <td>
                ...
                <a href="delete/<?php echo $player['id_player']?>"> <span data-feather="trash"></span>Elimitar</a>
...
<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" integrity="sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj" crossorigin="anonymous"></script>
      <script>window.jQuery || document.write('<script src="/docs/4.5/assets/js/vendor/jquery.slim.min.js"><\/script>')</script><script src="/docs/4.5/dist/js/bootstrap.bundle.min.js" integrity="sha384-1CmrxMRARb6aLqgBO7yyAxTOQE2AKb9GfXnEo760AUcUmFx3ibVJJAzGytlQcNXd" crossorigin="anonymous"></script>
        ...
        <script src="../js/boot_strap.js"></script></body>
  </html>
...
function addPlayer(){
insertPlayer($_GET["nombre"],$_GET["apellido"],$_GET["posicion"],$_GET["apodo"]);
